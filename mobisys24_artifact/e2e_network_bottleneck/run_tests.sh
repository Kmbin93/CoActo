...
s_core=32
bandwidth_list=(100 80 60 40 20)
num_tile=200
...
echo "    Bandwidth settings: ${bandwidth_list[@]}"
echo "    Bandwidth settings: ${bandwidth_list[@]}" >> $output_log
echo ""
...
total_runs=$(( ${#dnn_list[@]} * ${#batch_list[@]} * ${#policy_list[@]} * ${#bandwidth_list[@]} ))
    ...
    do
        ...
        do
            ...
            do
                ...
                edge_cmd="$shell_cmd 'cd ~/kmbin/CoActo/mobisys24_artifact/e2e_network_bottleneck && $edge_cmd_wo_ssh'"
